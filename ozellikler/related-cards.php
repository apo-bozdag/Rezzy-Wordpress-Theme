...
if ( ! class_exists( 'Related_Cards_Class' ) ) {
	class Related_Cards_Class {
		...
		public function rc( $atts ) {
			...
			$cat    = 'İLGİLİ YAZI';
			$out    = "<div class=\"ilgili-haber\"><div class=\"ilgili-haber-gorsel\"><a href=\"$url\" target=\"_blank\"><img class=\"img\" src=\"$img\" /></a></div><div class=\"ilgili-haber-kategori\"><a>$cat</a></div><div class=\"ilgili-haber-baslik\"><a href=\"$url\" target=\"_blank\">$baslik</a></div></div>";
			if ( $img != '' || $img != 0 ) {
				return $out;
			}
		}
