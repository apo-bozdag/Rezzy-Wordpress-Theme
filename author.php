   ...
   <div style="padding-left:1px;padding-right:1px;" class="container">
	<div style="max-width:100%; width:100%;" class="kutu">
	 <div class="yazar-sayfasi">
	    <img src="https://rezzy.akadirkaya.com/wp-content/uploads/2018/07/36781721_1038924759616355_4910277870036713472_n-150x150.jpg">
		<div class="yazar-sayfasi-yazi">
		<h5><?php the_author(''); ?><span class="yazar-maili"><?php the_author_url(''); ?></span></h5>
